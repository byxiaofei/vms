 ...
 * should have their encoding set to UTF-8 or UTF-16, otherwise events
...
public class HTMLLayout extends Layout{
	...
	protected final SimpleDateFormat sf = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");
	 ...
	 * <b>LocationInfo</b>. <p> Note that all option keys are case sensitive.
	 ...
	 * output. <p> If you are embedding this layout within an {@link
	 ...
	 * document title of the generated HTML document. <p> Defaults to 'Log4J Log
	 * Messages'.
	 */
	...
	public String format(LoggingEvent event){
		...
		sbuf.append("<td>");
		sbuf.append(sf.format(new Date(event.timeStamp)));
	...
	public String getHeader(){
		...
		sbuf.append("</head>" + Layout.LINE_SEP);
		sbuf
				.append("<body  onload=\"scroll(0,document.body.scrollHeight)\" bgcolor=\"#FFFFFF\" topmargin=\"6\" leftmargin=\"6\">"
						+ Layout.LINE_SEP);
		sbuf.append("<hr size=\"1\" noshade>" + Layout.LINE_SEP);
		sbuf.append("Log session start time " + sf.format(new java.util.Date())
				+ "<br>" + Layout.LINE_SEP);
