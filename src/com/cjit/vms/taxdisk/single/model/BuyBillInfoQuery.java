...
public class BuyBillInfoQuery extends BaseDiskModel{
	...
	public BuyBillInfoQuery(TaxDiskInfo disk,String fapiaoType) {
		super();
		...
		this.fapiaoType = fapiaoType;
		this.comment=TaxDiskUtil.comment_buy_ticket_information_query;
		this.applyTypeCode=TaxDiskUtil.Application_type_code_1;
		this.Id=TaxDiskUtil.id_buy_ticket_information_query;
	}
