...
<body onkeydow="enterkey(event)">
	...
	<tr>
		...
		<div id="tbl_current_status">
			...
			<span class="current_status_submenu">红票开具</span>
		</div>
	<%--//序号		开票日期	 billDate	客户名称	customerName		客户纳税人识别号 customerTaxno	
		...
		<table id="tbl_query" cellpadding="0" cellspacing="0" width="100%" border="0">
	 	...
	 	<table id="tbl_tools" width="100%" border="0">
			<tr>
				...
				<a href="#" name="BtnView" id="BtnView" onclick="issueRedBill()"><img src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1010.png"/>开具</a>
				</td>
			</tr>
		</table>
...
<!-- 								metlift end -->
	...
	%>
		...
		<td align="center"><%=bill.getRepnum()==null?"":bill.getRepnum()%></td>
<!-- 									metlife end -->
		...
		<td align="center"><%=bill.getCustomerTaxno()==null?"":bill.getCustomerTaxno()%></td>
		...
		<!-- 									metlife begin -->
		<td align="center"><%=bill.getChannelch()==null?"":bill.getChannelch()%></td>
		<td align="center"><%=bill.getFeeTypCh()==null?"":bill.getFeeTypCh()%></td>
		<td align="center"><%=bill.getHissDte()==null?"":bill.getHissDte()%></td>
		<td align="center"><%=bill.getBillFreq()==null?"":bill.getBillFreq()%></td>
		<td align="center"><%=bill.getdSource()==null?"":bill.getdSource()%></td>
<!-- 									metlife  end -->
		<td>
