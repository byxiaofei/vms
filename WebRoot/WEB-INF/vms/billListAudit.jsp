...
<form name="Form1" method="post" action="listBillAudit.action" id="Form1">
    <%
        ...
        <tr>
            <td class="centercondition">
                ...
                <div id="tbl_current_status">
                    ...
                    <span class="current_status_submenu">票据审核</span>
                </div>
                    ...
                    <table id="tbl_query" cellpadding="0" cellspacing="0" width="80%" border="0">
                        <tr>
                            ...
                            <td style="text-align: left;width:14%;"><input
                                    ...
                                    value="<s:property value='billCondition.ttmpRcno'/>" maxlength="20"/></td>
                            <td style="text-align: right;width: 6%;">合同号</td>
                            <td style="text-align: left;width:14%;"><input
                                    class="tbl_query_text" type="text" name="billCondition.cherNum"
                                    value="<s:property value='billCondition.cherNum'/>" maxlength="20"/></td>
                            ...
                            <td style="text-align: left;width:20%;"><input
                                    ...
                                    size='11'/> -- <input class="tbl_query_time" id="billEndDate"
                                                          type="text" name="billCondition.billEndDate"
                            ...
                            <td style="text-align: left;width:14%;">
                                <%-- <s:select name="billCondition.chanNel" list="chanNelList" listKey="key"
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;width: 14%;"><input type="text"
                            ...
                            <td style="text-align: left;width: 14%;">
                                <s:select name="billCondition.dsouRce" list="dsouRceList" listKey="key"
                                          listValue='value' cssClass="tbl_query_text" headerKey=""
                                          headerValue="请选择"/>
                            </td>
                            ...
                            <td style="text-align: left;width:20%;"><input
                                    ...
                                    onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'billEndDate\')}'})"
                                    size='11'/> -- <input class="tbl_query_time" id=""
                                                          type="text" name="billCondition.hissEndDte"
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;width: 20%;"><select
                            ...
                            <td style="width:80px;" align="right">
                                <input type="button" class="tbl_query_button" value="查询"
                                       ...
                                       onclick="submitForm('listBillAudit.action')"
                                />
                            </td>
                        </tr>
                    </table>
                            ...
                            <tr class="lessGrid rowB">
                               ...
                               <%--  <td align="center"><%=bill.getRepNum() == null ? "" : bill
                                ...
                                <td align="center">
                                    ...
                                    <a href="billAuditToTrans.action?curPage=<s:property value='paginationList.currentPage'/>&billId=<%=BeanUtils.getValue(bill, "billId")%>">
