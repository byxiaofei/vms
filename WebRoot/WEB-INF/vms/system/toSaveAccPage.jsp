...
<form name="formAccTitle" id="formAccTitle" action="saveAccTitle.action" method="post">
...
<table id="contenttable" class="lessGrid" cellspacing="0" width="100%" align="center" cellpadding="0" >
	...
	<tr>
		...
		<td width="60%">
				<input id="accTitleCode" name="accTitleCode" type="text" class="tbl_query_text" onblur="funAccTitleCode()" maxlength="20"/>&nbsp; 
		...
		<td>
			<input id="accTitleName" name="accTitleName" type="text" class="tbl_query_text" maxlength="100" onblur="funCheckTname()" />&nbsp; 
			<span class="spanstar">*</span>
