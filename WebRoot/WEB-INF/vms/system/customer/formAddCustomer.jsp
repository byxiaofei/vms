...
<body>
	<form name="formCustomer" id="formCustomer" action="saveCustomer.action" method="post">
		<div class="windowtitle" style="background:#004C7E; height:45px; line-height:45px; text-align:center; color:#FFF; font-weight:bold; font-size:14px;">新增客户</div>
	...
	--%>
			...
			<tr>
				...
				<td>
					<input size="30" id="customerID" class="tbl_query_text" name="customerID" type="text" maxlength="20"  onblur="funCheckCustomerID()"/>
			...
			<tr>
				...
				<td width="35%">
					<input size="30" id="customerCName" class="tbl_query_text" name="customerCName" type="text" maxlength="20" onblur="funCheckTname()" />
					&nbsp;
					<span style="color:red;" id="nm" >*</span>
					<label id="name" style="display:none;color:#FF0000;font-size:14">请输入中文</label>
					<label id="name1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
			...
			<tr>
				...
				<td width="35%">
					<input size="30" id="customerTaxno" class="tbl_query_text" name="customerTaxno" type="text" onblur="funCheckgTaxNo()" maxlength="18" />
					&nbsp;
					<span style="color:red;" class="checkFapiaoType hiddenStar">*</span>
					<label id="taxNo" style="display:none;color:#FF0000;font-size:14">纳税人识别号格式有误</label>
					<label id="taxNo1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
				<td width="15%" align="right" class="listbar">国籍:</td>
				<td width="35%">
					<select id="customerNationality" name=customerNationality>
						<s:iterator value="countrys" id="iList" status="stuts">
							<option value='<s:property value='customerNationality'/>' <s:if test='customerNationality=="CHN"'>selected</s:if>><s:property value='countrySName' /></option>
						</s:iterator>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td width="35%">
					<input size="40" id="customerAddress" class="tbl_query_text" name="customerAddress" type="text" maxlength="100" onblur="funCheckAddress()" />
					&nbsp;
					<span style="color:red;" class="checkFapiaoType hiddenStar">*</span>
					<label id="address1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
				<td width="15%" align="right" class="listbar">电话:</td>
				<td width="35%">
					<input size="30" id="customerPhone" class="tbl_query_text" name="customerPhone" type="text" maxlength="20" onblur="funCheckphone()" />
					&nbsp;
					<span style="color:red;" class="checkFapiaoType hiddenStar">*</span>
					<label id="phone" style="display:none;color:#FF0000;font-size:14">电话格式错误</label>
					<label id="phone1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" class="listbar">邮箱:</td>
				<td width="35%">
					<input size="30" id="customerEmail" class="tbl_query_text" name="customerEmail" type="text" onblur="funCheckemail()" />
					&nbsp;
					<span style="color:red;display:none" class="checkFapiaoType hiddenStar">*</span>
					<label id="email" style="display:none;color:#FF0000;font-size:14">邮箱格式错误</label>
					<label id="email1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
				<td width="15%" align="right" class="listbar">开户银行:</td>
				<td width="35%">
					<input size="30" id="customerCBank" class="tbl_query_text" name="customerCBank" type="text" onblur="funCheckCustomerCBank()" />
					&nbsp;
					<span style="color:red;" class="checkFapiaoType hiddenStar">*</span>
					<label id="bank" style="display:none;color:#FF0000;font-size:14">请输入字母或数字</label>
					<label id="bank1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" class="listbar">开户账号:</td>
				<td width="35%">
					<input size="30" id="customerAccount" class="tbl_query_text" name="customerAccount" type="text" maxlength="20" onblur="funCheckAccount()" />
					&nbsp;
					<span style="color:red;" class="checkFapiaoType hiddenStar">*</span>
					<label id="account" style="display:none;color:#FF0000;font-size:14">请输入数字</label>
					<label id="account1" style="display:none;color:#FF0000;font-size:14">请输入</label>
				</td>
			...
			<tr>
				...
				<td width="35%">
					<select id="fapiaoType" name="fapiaoType" onchange="checkFapiaoType()">
	...
	--%>
			<tr>
				...
				<td width="35%">
					<s:select list="dataSourceList" name="datasSource" id="datasSource" headerKey="1" listKey="value" listValue="text" disabled="true"></s:select>
				</td>
			</tr>
		</table>
		...
		<table id="tbl_context" class="lessGrid" cellspacing="0" width="100%" align="center" cellpadding="0">
			<tr>
				...
				<td width="35%">
					<input size="40" id="linkName" class="tbl_query_text" name="linkName" type="text" maxlength="100" />
					&nbsp;
				</td>
				<td width="15%" align="right" class="listbar">联系人电话</td>
				<td width="35%">
					<input size="40" id="linkPhone" class="tbl_query_text" name="linkPhone" type="text" maxlength="100" onblur="funCheckLinkphone()" />
					&nbsp;
					<label id="ph" style="display:none;color:#FF0000;font-size:14">电话格式错误</label>
				</td>
			</tr>
			<tr>
			</tr>
			<tr>
				...
				<td width="35%">
					<input size="40" id="linkAddress" class="tbl_query_text" name="linkAddress" type="text" maxlength="100" />
					&nbsp;
				</td>
				<td width="15%" align="right" class="listbar">客户邮编</td>
				<td width="35%">
					<input size="40" id="customerZipCode" class="tbl_query_text" name="customerZipCode" type="text" maxlength="100" onblur="funCheckLinkZip()" />
					&nbsp;
					<label id="zip" style="display:none;color:#FF0000;font-size:14">邮编格式错误</label>
				</td>
			</tr>
			<tr>
			</tr>
		...
		<div id="ctrlbutton" class="ctrlbutton" style="border:0px">
			...
			/>
			<input type="button" class="tbl_query_button" onMouseMove="this.className='tbl_query_button_on'" onMouseOut="this.className='tbl_query_button'" onclick="window.close()" name="BtnReturn" value="取消"
				id="BtnReturn"
			/>
		</div>
	</form>
