		...
		<td class="centercondition">
			...
			<tr>
				<td align="right">机构名称</td>
							<td width="280">
									<input type="hidden" id="inst_id" name="instId" value='<s:property value="inputInvoiceNew.instId"/>'>
									<input type="text" class="tbl_query_text_readonly1" id="inst_Name" name="instName" value='<s:property value="inputInvoiceNew.instName"/>' >
						    </td>
			...
			<tr>
				...
				<td width="35%">
					<input size="30" id="billCode" style="height: 21px;" readonly class="tbl_query_text_readonly1" 
				...
				<td width="35%">
					<input size="30" id="billNo"  style="height: 21px;" readonly class="tbl_query_text_readonly1"  readOnly class="tbl_query_text" name="billNo" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.billNo"/>'/>
					&nbsp;
					<span style="color:red;" id="nm" >*</span>
				</td>
			</tr>
			<tr>
				...
				<td width="35%">
					<input size="30" id="vendorName" class="tbl_query_text" name="vendorName" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.vendorName"/>'/>
				</td>
				 <td width="15%" align="right" class="listbar">供应商纳税人识别号:</td>
				<td width="35%">
					<input size="30" id="TaxNo" class="tbl_query_text" name="taxNo" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.taxNo"/>'/>
				</td>
			</tr>
			<tr>
				...
				<td width="35%">
					<input size="40" id="amt" class="tbl_query_text" name="amt" type="text" onblur="taxRateAndAmt()" maxlength="100" value='<s:property value="inputInvoiceNew.amt"/>' onblur='taxRateAndAmt()'/>
					&nbsp;
					<span style="color:red;" id="nm" >*</span>
				...
				<td width="35%">
					<input size="30" id="amtRate" class="tbl_query_text" name="taxRate"  onblur="taxRateAndAmt()" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.taxRate" />'/>
					&nbsp;
					<span style="color:red;" id="nm" >*</span>
				</td>
			</tr>
			<tr>
				...
				<td width="35%">
					<input size="30" id="taxAmt" class="tbl_query_text" name="taxAmt" type="text" maxlength="20" onclick="SumTaxAmt()" value='<s:property value="inputInvoiceNew.taxAmt"/>'/>
					&nbsp;
					<span style="color:red;" id="nm">*</span>
				</td>
				<td width="15%" align="right" class="listbar">发票总额:</td>
				<td width="35%">
					<input size="30" id="amtTaxAmt" class="tbl_query_text" name="amtTaxSum" type="text" maxlength="20" onclick="sumAmtTaxt()" value='<s:property value="inputInvoiceNew.amtTaxSum"/>'/>
					&nbsp;
					<span style="color:red;" id="nm">*</span>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="35%">
				    <input size="30" id="directionID" class="tbl_query_text" name="directionID" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.directionId"/>'/>
					&nbsp;<span style="color:red;" id="nm">*</span>
				</td>
				<td width="15%" align="right" >进项转出科目明细编码:</td>
				<td width="35%">
					<input size="30" id="trans_item" class="tbl_query_text" name="trans_item" type="text" maxlength="20" value='<s:property value="inputInvoiceNew.temp2"/>'/>
					&nbsp;<span style="color:red;" id="nm">*</span>
				</td>
