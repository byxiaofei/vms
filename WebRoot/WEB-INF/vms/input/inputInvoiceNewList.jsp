			...
			<tr>
				<td align="right">机构名称</td>
							<td width="280">
									...
									<input type="text" readonly class="tbl_query_text_readonly1" class="tbl_query_text" id="inst_Name" name="instName" value='<s:property value="inputInvoiceNew.instName"/>' onclick="setOrg(this);" >
						    </td>
