	...
	$(function() {
		$("#BtnSave").click(function() {
			if (checkForm()) {
				...
				submitForm("saveItemInfo.action");
			}
			...
			<div id="editsubpanel" class="editsubpanel">
				<div style="overflow: auto; width: 100%;">
					...
					<table id="contenttable" class="lessGrid" cellspacing="0" width="100%" align="center" cellpadding="0">
						<tr class="header">
							<th colspan="4">
								<s:if test="!createFlag">修改认定类型</s:if>
								<s:else>新增认定类型</s:else>
								<s:hidden name="itemInfoForm.parentCode"></s:hidden>
								<s:hidden name="itemInfoForm.path"></s:hidden>
								<s:hidden name="createFlag"></s:hidden>
								<s:hidden name="itemInfoForm.taxNo"></s:hidden>
							</th>
						</tr>
						<tr>
							<td align="right" class="listbar" style="width:120px" >类型编号:</td>
							<td>
								<s:if test="createFlag">
									<s:textfield id="itemCode" name = "itemInfoForm.itemCode" cssClass="tbl_query_text2" maxlength="50"></s:textfield>
								</s:if>
								<s:else>
									<s:textfield id="itemCode" name = "itemInfoForm.itemCode" cssClass="tbl_query_text_readonly" readonly="true"></s:textfield>
								</s:else>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<tr>
							<td align="right" class="listbar">类型名称:</td>
							<td>
								<s:textfield name = "itemInfoForm.itemName" cssClass="tbl_query_text2" maxlength="50"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<%-- <tr>
							...
							<td>
								<s:textfield name="itemInfoForm.taxNo" cssClass="tbl_query_text2"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr> 
						<tr>
							...
							<td>
								<s:select name="itemInfoForm.taxRate" list="taxRateSelList" listKey='value' listValue='text' cssClass="tbl_query_text1"></s:select>
								<span class="spanstar">*</span>
							</td>
						</tr>--%>
						<tr>
							...
							<td>
								<s:textarea name="itemInfoForm.remark"></s:textarea>
							</td>
						</tr>
