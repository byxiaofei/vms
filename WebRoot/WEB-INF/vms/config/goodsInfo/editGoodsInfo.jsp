...
<body scroll="no" style="overflow:hidden;">
	<div class="showBoxDiv">
		<form id="main" name="formBusiness" method="post" action="saveGoodsInfo.action">
			<div id="editsubpanel" class="editsubpanel">
				<div style="overflow: auto; width: 100%;">
					<table id="contenttable" class="lessGrid" cellspacing="0" width="100%" align="center" cellpadding="0">
						<tr class="header">
							<th colspan="4">
								<s:if test="!createFlag">修改商品信息</s:if>
								<s:else>修改商品信息</s:else>
						...
						<tr>
							...
							<td>
								<s:if test="createFlag">
									<s:textfield name="goodsInfo.goodsId" cssClass="tbl_query_text2" dataType="Custom" regexp="^[a-zA-Z\d]+$" maxlength="50" msg="商品编号只能包含数字和字母"></s:textfield>
								</s:if>
								<s:else>
									<s:textfield name="goodsInfo.goodsId" cssClass="tbl_query_text_readonly" readonly="true" ></s:textfield>
								</s:else>
						...
						<tr>
							...
							<td>
								<s:textfield name="goodsInfo.goodsName" cssClass="tbl_query_text2"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:textfield name="goodsInfo.model" cssClass="tbl_query_text2"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:textfield name="goodsInfo.unit" cssClass="tbl_query_text2"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:textfield name="goodsInfo.taxNo" cssClass="tbl_query_text_readonly" readonly="true"></s:textfield>
								<span class="spanstar">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<s:textarea name="goodsInfo.remark"></s:textarea>
							</td>
						</tr>
					</table>
				</div>
