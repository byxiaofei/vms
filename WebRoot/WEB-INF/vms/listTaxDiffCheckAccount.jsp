...
<table id="tbl_main" cellpadding="0" cellspacing="0" class="tablewh100">
	<tr>
		...
		<div id="tbl_current_status">
			...
			<span class="current_status_submenu">税会差异对账</span>
		</div>
		...
		<table id="tbl_query" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td width="50">产品</td> 
				<td width="180">
				<input id="receiveUserId" class="tbl_query_text" name="goodsName" type="text" value="<s:property value='goodsName' />" /></td>
				<td colspan="2">
				...
				onclick="submitForm('listTaxDiffCheckAccount.action?paginationList.showCount=false');" name="cmdSelect" value="查询" id="cmdSelect" />				
				</td>
			</tr>
		</table>
		</div>
