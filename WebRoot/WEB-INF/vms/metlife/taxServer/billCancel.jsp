...
<OBJECT ID=sk CLASSID="clsid:003BD8F2-A6C3-48EF-9B72-ECFD8FC4D49F" codebase="NISEC_SKSCX.ocx#version=1,0,0,1"
...
<head>
    ...
    <script type="text/javascript">
        ...
        function updateCancelBillResult(cancelRes) {
            $.ajax({
                url: 'updateCancelBillResult.action',
                type: 'POST',
                async: false,
...
<form name="Form1" method="post" action="listBillCancel.action" id="Form1">
            ...
            <td class="centercondition">
                ...
                <div class="widthauto1">
                    <table id="tbl_query" cellpadding="0" cellspacing="0" width="80%" border="0">
                        <tr>
                            <td>投保单号</td>
                            <td><input type="text" class="tbl_query_text" name="billCancelInfo.vtiTtmprcon"
                                       value="<s:property value='billCancelInfo.vtiTtmprcon'/>"/></td>
                        ...
                        <tr>
                            ...
                            <td><s:select name="billCancelInfo.billFreq" list="billFreqlList" listKey="key"
                                          listValue='value' cssClass="tbl_query_text" headerKey=""
                                          headerValue="请选择"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="billCancelInfo.issueType" name="billCancelInfo.issueType"
                                        style="width:120px">
                                    <option value=""
	...
	%>
                            <tr class="lessGrid rowB">
                                ...
                                <td align="center"><%=billCancel.getTtmpRcno() %>
                                </td>
                                <td align="center"><%=billCancel.getInsureId() %>
                                </td>
                                <td align="center"><%=billCancel.getRepnum() %>
                                </td>
                                <td align="center"><%=billCancel.getBillDate() != null ? billCancel.getBillDate() : ""%>
                                </td>
                                <td align="center"><%=billCancel.getCustomerName()%>
                                </td>
                                <td align="center"><%=billCancel.getBillCode()%>
                                </td>
                                <td align="center"><%=billCancel.getBillNo()%>
                                </td>
                                ...
                                <td align="center"><%=billCancel.getChannelCh() %>
                                </td>
                                <td align="center"><%=billCancel.getFeeTypCh() %>
                                </td>
                                <td align="center"><%=billCancel.getHissDte() %>
                                </td>
