...
<head>
	...
	<script>  
	function revoke(){
		submitAction(document.forms[0], "billRedIssueList.action?fromFlag=menu");
	}
	</script>
	...
	<tr>
		<td class="centercondition">
			<div id="tbl_current_status">
				...
				<span class="current_status_submenu">查看详情</span>
			</div>
  	...
  	<div id="lessGridList" style="overflow: auto; width: 100%;">
		<table class="lessGrid" cellspacing="0" rules="all" border="0"  cellpadding="0" style="border-collapse: collapse; width: 100%;">
			...
			%>
				...
				<td align="right"><%=NumberUtils.format(trans.getTaxAmt(),"",2)%></td> <!-- 税额 -->
