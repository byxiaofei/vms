    ...
    <table id="tbl_main" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td class="centercondition">
                ...
                </br> <!--	<div style="overflow:auto;width:100%;" id="list1">-->
                    ...
                    <div id="rDiv" style="width: 0px;height: auto;">
                        <table class="lessGrid" cellspacing="0" rules="all" border="0"
                            ...
                            <tr class="lessGrid rowB">
                                ...
                                <td align="center"><%=trans.getCustomerName()%>
                                </td>
                                <td align="center"><%=trans.getCustomerTaxno()==null?"":trans.getCustomerTaxno()%>
                                </td>
                                <td align="center"><%=trans.getCherNum()%>
                                </td>
                                <td align="center"><%=trans.getRepNum()%>
                                </td>
