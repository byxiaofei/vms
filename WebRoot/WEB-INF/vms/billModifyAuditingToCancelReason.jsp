...
<%@ page language="java" import="java.util.*" import="com.opensymphony.util.BeanUtils" import="com.cjit.vms.trans.model.BillInfo" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<body onLoad="" onmousemove="MM(event)" onmouseout="MO(event)">
	<form name="Form1" method="post" action="" id="Form1">
		<input type="hidden" id="billId" value='<%=request.getAttribute("billId")%>' />
		<input type="hidden" id="submitFlag" value='<%=request.getAttribute("submitFlag")%>' />
		...
		<div class="centercondition">
			...
			<div id="bankbox" style="width: 100%;height: 150px;">
				...
				<!-- </div> -->
				<div class="bottombtn">
					<input type="button" class="tbl_query_button" value="保存" onMouseMove="this.className='tbl_query_button_on'" onMouseOut="this.className='tbl_query_button'" name="btSave" id="btSave"
						onclick="cancel()"
					/>
