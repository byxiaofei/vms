...
<body onkeydow="enterkey(event)">
	<form name="Form1" method="post" action="listInputRedReceiptApprove.action" id="Form1">
		<%
			...
			<tr>
				<td class="centercondition">
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							<td align="left">
								<a href="#" name="BtnView" id="BtnView" onclick="cancel(13)">
									<img src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1017.png" />
									审核通过
								</a>
								<a href="#" name="BtnView" id="BtnView" onclick="cancel(1)">
					...
					<div id="lessGridList4" style="overflow: auto; width: 100%;">
						<table class="lessGrid" cellspacing="0" rules="all" border="0" cellpadding="0" style="border-collapse: collapse; width: 100%;">
							...
							<tr class="lessGrid rowB">
								...
								<td align="right">
									<a href="approveSpecialticket.action?billId=<%=BeanUtils.getValue(bill, "billId")%>">
										<img src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1042.png" title="复核数据" style="border-width: 0px;" />
