...
<body onLoad="javascript:tips()" onmousemove="MM(event)" onmouseout="MO(event)">
	...
	<tr class="row1">
		...
		<td align="left" width="90%" colspan="5">
			<input type="text" name="billInfo.customerName" id="billInfo.customerName" value="<s:property value='billInfo.customerName'/>" size="100" readonly class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right" width="10%">
		...
		<td align="left" colspan="5">
			<input type="text" name="billInfo.customerTaxno" id="billInfo.customerTaxno" value="<s:property value='billInfo.customerTaxno'/>" size="100" readonly class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td align="left" colspan="5">
			<input type="text" name="billInfo.customerAddressandphone" id="billInfo.customerAddressandphone" value="<s:property value='billInfo.customerAddressandphone'/>" size="100" readonly class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td align="left" colspan="5">
			<input type="text" name="billInfo.customerBankandaccount" id="billInfo.customerBankandaccount" value="<s:property value='billInfo.customerBankandaccount'/>" size="100" readonly class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td valign="top" colspan="6">
		<table cellspacing="0" border="0" cellpadding="0" width="100%" style="BORDER:#D6D6D6 1px solid" height="100%">
		<tr>
			<td>
				<iframe id="subTableFrame" scrolling="auto" src="listBillItem1.action?billId=<s:property value='billInfo.billId'/>&isHandiwork=<s:property value='billInfo.isHandiwork'/>" height="110px" width="100%" frameborder="0"></iframe>
			</td>
		</tr>
		</table>
		</td>
	...
	<tr class="row1">
		...
		<td>
			<input type="text" name="billInfo.amtSum" id="billInfo.amtSum" value="<s:property value='billInfo.amtSum'/>"
				onfocus="loadBillAmtInfo();" onkeypress="checkkey(value);" onblur="formatAmount(this,2,0,'true');" />
		</td>
		<td align="right">
			合计税额:&nbsp;
		...
		<td>
			<input type="text" name="billInfo.taxAmtSum" id="billInfo.taxAmtSum" value="<s:property value='billInfo.taxAmtSum'/>"
				onfocus="loadBillAmtInfo();" onkeypress="checkkey(value);" onblur="formatAmount(this,2,0,'true');" />
		</td>
	</tr>
	<tr class="row1">
		...
		<td colspan="3">
			...
			<s:select name="instCode" list="authInstList" listKey='id' listValue='name' onchange="loadOurInfo(this.value)" disabled="disabled"/>
			</s:if>
			<s:if test="authInstList == null || authInstList.size == 0">
			<select name="instCode" readonly class="readonly"class="readOnlyText">
		...
		<td rowspan="5">
			<textarea name="billInfo.remark" id="billInfo.remark" cols="60" rows="7" readonly="readonly"><s:property value='billInfo.remark'/></textarea>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td colspan="3">
			<input type="text" name="billInfo.name" id="billInfo.name" value="<s:property value='billInfo.name'/>" size="100" readonly="readonly" class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td colspan="3">
			<input type="text" name="billInfo.taxno" id="billInfo.taxno" value="<s:property value='billInfo.taxno'/>" size="100" readonly="readonly" class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td colspan="3">
			<input type="text" name="billInfo.addressandphone" id="billInfo.addressandphone" value="<s:property value='billInfo.addressandphone'/>" size="100" readonly="readonly" class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td colspan="3">
			<input type="text" name="billInfo.bankandaccount" id="billInfo.bankandaccount" value="<s:property value='billInfo.bankandaccount'/>" size="100" readonly="readonly" class="readonly"/>
		</td>
	</tr>
	<tr class="row1">
		<td align="right">
		...
		<td>
			<input type="text" name="billInfo.payee" id="billInfo.payee" value="<s:property value='billInfo.payee'/>" readonly="readonly" class="readonly"/>
		</td>
		<td align="right">
			复核人:&nbsp;
		</td>
		<td>
			<s:property value='billInfo.reviewerName'/>
			<input type="hidden" name="billInfo.reviewer" id="billInfo.reviewer" value="<s:property value='billInfo.reviewer'/>" readonly="readonly" class="readonly"/>
		</td>
		<td align="right">
			开票人:&nbsp;
		</td>
		<td>
			<s:property value='billInfo.drawerName'/>
			<input type="hidden" name="billInfo.drawer" id="billInfo.drawer" value="<s:property value='billInfo.drawer'/>" readonly="readonly" class="readonly"/>
		</td>
	</tr>
	</table>
	<div id="ctrlbutton" class="ctrlbutton" style="border:0px">
		...
		<input type="button" class="tbl_query_button" value="返回"
			onMouseMove="this.className='tbl_query_button_on'" onMouseOut="this.className='tbl_query_button'"
			name="btGoBack" id="btGoBack" onclick="goBack()" />
	</div>
	<script language="javascript" type="text/javascript">
